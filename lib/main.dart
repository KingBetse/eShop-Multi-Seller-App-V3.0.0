...
void main() async {
  ...
  // 2. Firebase — only initialize if not already done
  try {
  ...
  // 6. Firebase Messaging background handler
  if (!kIsWeb) {
  ...
  // 7. Launch the app — no loading screen
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider<AddProductProvider>(
            create: (_) => AddProductProvider(), lazy: true),
        ChangeNotifierProvider<CountryProvider>(
            create: (_) => CountryProvider(), lazy: true),
        ChangeNotifierProvider<BrandProvider>(
            create: (_) => BrandProvider(), lazy: true),
        ChangeNotifierProvider<PickUpLocationProvider>(
            create: (_) => PickUpLocationProvider(), lazy: true),
        ChangeNotifierProvider<TaxProvider>(
            create: (_) => TaxProvider(), lazy: true),
        ChangeNotifierProvider<SettingProvider>(
            create: (_) => SettingProvider(sharedPreferences), lazy: true),
        ChangeNotifierProvider<LoginProvider>(
            create: (_) => LoginProvider(), lazy: true),
        ChangeNotifierProvider<ZipcodeProvider>(
            create: (_) => ZipcodeProvider(), lazy: true),
        ChangeNotifierProvider<CategoryProvider>(
            create: (_) => CategoryProvider(), lazy: true),
        ChangeNotifierProvider<AttributeProvider>(
            create: (_) => AttributeProvider(), lazy: true),
        ChangeNotifierProvider<MediaProvider>(
            create: (_) => MediaProvider(), lazy: true),
        ChangeNotifierProvider<SystemProvider>(
            create: (_) => SystemProvider(), lazy: true),
        ChangeNotifierProvider<ProductListProvider>(
            create: (_) => ProductListProvider(), lazy: true),
        ChangeNotifierProvider<ProfileProvider>(
            create: (_) => ProfileProvider(), lazy: true),
        ChangeNotifierProvider<ReviewListProvider>(
            create: (_) => ReviewListProvider(), lazy: true),
        ChangeNotifierProvider<SalesReportProvider>(
            create: (_) => SalesReportProvider(), lazy: true),
        ChangeNotifierProvider<SearchProvider>(
            create: (_) => SearchProvider(), lazy: true),
        ChangeNotifierProvider<FaQProvider>(
            create: (_) => FaQProvider(), lazy: true),
        ChangeNotifierProvider<EditProductProvider>(
            create: (_) => EditProductProvider(), lazy: true),
        ChangeNotifierProvider<WalletTransactionProvider>(
            create: (_) => WalletTransactionProvider(), lazy: true),
        ChangeNotifierProvider<StockProviderProvider>(
            create: (_) => StockProviderProvider(), lazy: true),
        ChangeNotifierProvider<AddPickUpLocationProvider>(
            create: (_) => AddPickUpLocationProvider(), lazy: true),
        ChangeNotifierProvider<CityProvider>(
            create: (_) => CityProvider(), lazy: true),
        ChangeNotifierProvider<PushNotificationProvider>(
            create: (_) => PushNotificationProvider(), lazy: true),
        ...
        BlocProvider(
            ...
            lazy: true),
        BlocProvider(
            create: (_) => FetchOrdersCubit(OrdersRepository()), lazy: true),
        BlocProvider(
        ...
        BlocProvider<CountryCodeCubit>(
            create: (_) => CountryCodeCubit(), lazy: true),
        BlocProvider<LanguageCubit>(
            create: (_) => LanguageCubit(), lazy: true),
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    final Widget homeScreen =
        widget.isLoggedIn ? const Dashboard() : const Login();
