    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
            labelText: "TITLE".translate(context: context) ?? "TITLE"),
      ),
    );
  }
  ...
  Widget _buildDescriptionTextField() {
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
            labelText:
                "DESCRIPTION".translate(context: context) ?? "DESCRIPTION"),
      ),
    );
  }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Text(
              'SEARCH_USER'.translate(context: context) ?? 'SEARCH_USER',
    ...
    return _users.isEmpty
        ...
        : Column(
            ...
            children: [
              ...
              Text(
                "ADDED_USERS".translate(context: context) ?? "ADDED_USERS",
