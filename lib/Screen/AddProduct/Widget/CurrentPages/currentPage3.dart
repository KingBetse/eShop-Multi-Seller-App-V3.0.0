  ...
  return Column(
    ...
    children: [
      getPrimaryCommanText(
          "Product Main Image".translate(context: context), true),
      getCommanSizedBox(),
      Row(children: [
        getCommonButtonAdd(
            "Upload".translate(context: context), 1, setState, context),
      ...
      getCommanSizedBox(),
      getPrimaryCommanText(
          "Product Other Images".translate(context: context), true),
      getCommanSizedBox(),
      Row(
        children: [
          getCommonButtonAdd(
              "Upload".translate(context: context), 2, setState, context),
          getCommanSizedBoxWidth(),
          Expanded(
            flex: 3,
      ...
      getCommanSizedBox(),
      getPrimaryCommanText(
          "Select Video Type".translate(context: context), false),
      getCommanSizedBox(),
        ...
        children: [
          Expanded(
            ...
            child: getPrimaryCommanText(
                'Product Description'.translate(context: context), true),
          ),
        ],
      ),
      ...
      Row(
        children: [
          Expanded(
            flex: 2,
            child: getPrimaryCommanText(
                "Extra Description".translate(context: context), true),
          ),
        ],
      ),
