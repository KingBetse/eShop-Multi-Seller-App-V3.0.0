          ...
          items: <BottomNavigationBarItem>[
            BottomNavigationBarItem(
              icon: SvgPicture.asset(
                DesignConfiguration.setNewSvgPath(Assets.homeInactive),
              ),
              activeIcon: SvgPicture.asset(
                DesignConfiguration.setNewSvgPath(Assets.homeActive),
                height: 25,
              ),
            ...
            BottomNavigationBarItem(
              icon: SvgPicture.asset(
                DesignConfiguration.setNewSvgPath(Assets.orderInactive),
              ),
              activeIcon: SvgPicture.asset(
                DesignConfiguration.setNewSvgPath(Assets.orderActive),
                height: 25,
              ),
              label: 'ORDERS'.translate(context: context),
            ),
            BottomNavigationBarItem(
              icon: SvgPicture.asset(
                DesignConfiguration.setNewSvgPath(Assets.productInactive),
              ),
              activeIcon: SvgPicture.asset(
                DesignConfiguration.setNewSvgPath(Assets.productActive),
                height: 25,
              ),
