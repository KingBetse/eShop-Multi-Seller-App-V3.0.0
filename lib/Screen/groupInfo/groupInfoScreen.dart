  ...
  Widget _buildTitleTextField() {
    return Container(
      ...
      child: TextFormField(
        ...
        validator: (value) {
          if ((value ?? "").isEmpty) {
            return "PLEASE_ENTER_TITLE".translate(context: context);
          }
          return null;
        },
        decoration:
            InputDecoration(labelText: "TITLE".translate(context: context)),
      ),
    );
  }
  ...
  Widget _buildDescriptionTextField() {
    return Container(
      ...
      child: TextFormField(
        ...
        validator: (value) {
          if ((value ?? "").isEmpty) {
            return "PLEASE_ENTER_DESCRIPTION".translate(context: context);
          }
          return null;
        },
    ...
    return _users.isEmpty
        ...
        : Column(
            ...
            children: [
              ...
              Text(
                "ADDED_USERS".translate(context: context),
      ...
      return BlocConsumer<EditGroupCubit, EditGroupState>(
        listener: (context, state) {
          if (state is EditGroupSuccess) {
            ...
            setSnackbar(
                "GROUP_UPDATED_SUCCESSFULLY".translate(context: context),
                context);
    ...
    return Column(
      children: [
        ListTile(
          ...
          title: Text("ADD_USER".translate(context: context)),
        ),
        ListTile(
          onTap: () {
            showDialog<bool?>(
          ...
          title: Text(
            "DELETE_GROUP".translate(context: context),
            style: const TextStyle(
              color: Colors.red,
            ),
          ),
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        ...
        appBar:
            getSimpleAppBar("GROUP_INFO".translate(context: context), context,
                onTapBackButton: () {
          Navigator.of(context).pop(_groupDetails);
        }),
