          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('ORDER_DETAILS'.translate(context: context)).bold(),
                  ListView.separated(
                    shrinkWrap: true,
    ...
    if (widget.order.orderItems.length > 4) {
      return GestureDetector(
        ...
        child: Padding(
          ...
          child: Text('VIEW_MORE'.translate(context: context))
              .underline()
              .color(primary),
        ),
      );
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                shape: BoxShape.circle, color: primary.withValues(alpha: 0.08)),
            width: 36,
            height: 36,
          ),
          const SizedBox(
