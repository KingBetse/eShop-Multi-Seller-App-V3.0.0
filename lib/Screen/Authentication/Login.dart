...
//============================= Build Method ===================================
  ...
  Widget setSignInLabel() {
    return Padding(
      ...
      child: Align(
        ...
        child: Text(
          'Login In'.translate(context: context),
  ...
  setDontHaveAcc() {
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          Text(
            "DONT_HAVE_ACCOUNT".translate(context: context),
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
              ...
              enabledBorder: OutlineInputBorder(
                  borderSide: BorderSide(color: black.withValues(alpha: 0.2)),
  ...
  signInSubTxt() {
    return Padding(
      ...
      child: Text(
        'PLEASE_ENTER_LOGIN_DETAILS'.translate(context: context),
        style: Theme.of(context).textTheme.titleSmall!.copyWith(
              color: black.withValues(alpha: 0.38),
              fontWeight: FontWeight.bold,
              fontFamily: 'ubuntu',
            ),
      ),
