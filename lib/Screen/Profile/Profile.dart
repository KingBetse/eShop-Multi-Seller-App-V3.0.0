...
class StateProfile extends State<Profile> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    profileProvider!.lowStockLimitC = TextEditingController();
...
//============================= dispose method =================================
  ...
  void dispose() {
    ...
    profileProvider!.lowStockLimitC!.dispose();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        bottomNavigationBar: Padding(
          ...
          child: AppBtn(
            title: "Update Profile".translate(context: context),
            ...
            onBtnSelected: () async {
              ...
              if (form.validate()) {
                ...
                profileProvider!.lowStockLimit =
                    profileProvider!.lowStockLimitC!.text;
                setStateNow();
                _playAnimation();
                checkNetwork();
              }
                ...
                child: Column(
                  children: [
                    ...
                    CommonField(
                      ...
                      labelText: "CUR_PASS_LBL".translate(context: context),
                    ...
                    CommonField(
                      ...
                      labelText: "NEW_PASS_LBL".translate(context: context),
