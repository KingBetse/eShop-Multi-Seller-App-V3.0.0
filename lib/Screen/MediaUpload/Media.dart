...
class _MediaState extends State<Media> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: getAppBar('Media'.translate(context: context), context),
      body: isNetworkAvail
          ? _showContent()
          : noInternet(
              context,
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Text(
                  "Upload media from Gellery".translate(context: context),
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      "Select File".translate(context: context),
      ...
      child: InkWell(
        ...
        child: Stack(
          children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                            '${"Name".translate(context: context)} : ${mediaProvider!.mediaList[index].name!}'),
                        Text(
                            '${"Sub Directory".translate(context: context)} : ${mediaProvider!.mediaList[index].subDic!}'),
                        Text(
                            '${"Size".translate(context: context)} : ${mediaProvider!.mediaList[index].size!}'),
                        Text(
                            '${"extension".translate(context: context)} : ${mediaProvider!.mediaList[index].extention!}'),
                      ],
                    ),
                  ),
                ),
            ...
            Container(
              color: Colors.black.withValues(
                  alpha: mediaProvider!.mediaList[index].isSelected ? 0.1 : 0),
            ),
            widget.from != "main"
                ? mediaProvider!.mediaList[index].isSelected
                    ? const Align(
