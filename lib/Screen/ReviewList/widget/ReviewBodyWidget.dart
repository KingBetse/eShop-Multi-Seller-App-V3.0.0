                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                          "${salesProvider!.reviewList.length}   ${  'ratings'.translate(context: context)}")
                    ],
                  ),
                ),
                Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                              "Images By Customers".translate(context: context),
            ...
            child: Row(
              ...
              children: [
                Row(
                  children: [
                    Text(
                      "${salesProvider!.reviewList.length} ${  "Review".translate(context: context)}",
                      style: const TextStyle(
                        fontWeight: FontWeight.bold,
                ...
                salesProvider!.revImgList.isNotEmpty
                    ? Row(
                        children: [
                          ...
                          Text(
                              "with photo".translate(context: context),
                            style: const TextStyle(fontWeight: FontWeight.bold),
                          ),
                        ],
                      )
