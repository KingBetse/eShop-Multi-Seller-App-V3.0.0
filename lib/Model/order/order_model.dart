...
class OrderModel {
  ...
  void changeValues(OrderModel order) {
    ...
    returnItemImage = order.returnItemImage;
  }
  ...
  OrderModel copyWith({
    ...
    return OrderModel(
      ...
      returnItemImage: returnItemImage ?? this.returnItemImage,
    );
  }
...
//GETTERS
  ...
  factory OrderModel.fromJson(Map<String, dynamic> json) {
    return OrderModel(
      ...
      returnItemImage: json['return_item_image'] == null
          ? []
          : List<dynamic>.from(json["return_item_image"]!.map((x) => x)),
    );
  }
...
class OrderItem {
  ...
  final List<dynamic> returnItemImage;
